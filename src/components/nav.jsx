    ...
    <>
      <div className="sm:px-5 dark:bg-gray-700 dark:text-gray-100 text-[] sm:text-sm shadow sm:font-bold lg:px-20 h-20 flex justify-between items-center">
        <div className="flex lg:gap-2 sm:gap-1 items-center">
          <img
            className="sm:w-6 md:w-8 md:h-8 sm:h-6 lg:w-10 lg:h-10"
            ...
            alt=""
          />
          <h1 className="sm:text-sm md:text-lg sm:font-bold lg:text-xl  lg:font-bold">
            My learning journal
          </h1>
        </div>
        <ul className="flex md:gap-7 lg:gap-10 items-center  sm:font-semibold sm:text-[12px] sm:gap-3">
