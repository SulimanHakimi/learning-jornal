...
function Post() {
  ...
  return (
    <>
      <div className=" lg:px-20 sm:px-10 py-20 grid lg:grid-cols-3 gap-5 sm:grid-cols-1 md:grid-cols-2 bg-zinc-50">
        ...
        <button className="underline font-semibold text-sm bg-slate-400">
          View More
        </button>
      </div>
    </>
