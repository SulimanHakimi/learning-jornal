...
function Card({data}) {
  return (
    <>
      <div className="min-h-[420px] dark:bg-slate-800 w-[350px] bg-bgim rounded overflow-hidden shadow-xl">
        <img className="w-full h-1/2 object-cover" src={data?.urlToImage} alt="" />
